# This Makefile is for the Acme::6502 extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/Acme/6502.pm]
#     AUTHOR => q[Andy Armstrong <andy@hexten.net>]
#     NAME => q[Acme::6502]
#     PL_FILES => {  }
#     PREREQ_PM => { Test::More=>q[0], version=>q[0] }
#     VERSION_FROM => q[lib/Acme/6502.pm]
#     clean => { FILES=>q[Acme-6502-*] }
...
TO_INST_PM = lib/Acme/6502.pm \
	lib/Acme/6502/Tube.pm \
	t.pl

PM_TO_BLIB = lib/Acme/6502.pm \
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW)\
	  lib/Acme/6502.pm $(INST_MAN3DIR)/Acme::6502.$(MAN3EXT) \
	  lib/Acme/6502/Tube.pm $(INST_MAN3DIR)/Acme::6502::Tube.$(MAN3EXT) 
...
clean :: clean_subdirs
	-$(RM_RF) Acme-6502-* ./blib $(MAKE_APERL_FILE) $(INST_ARCHAUTODIR)/extralibs.all $(INST_ARCHAUTODIR)/extralibs.ld perlmain.c tmon.out mon.out so_locations pm_to_blib *$(OBJ_EXT) *$(LIB_EXT) perl.exe perl perl$(EXE_EXT) $(BOOTSTRAP) $(BASEEXT).bso $(BASEEXT).def lib$(BASEEXT).def $(BASEEXT).exp $(BASEEXT).x core core.*perl.*.? *perl.core core.[0-9] core.[0-9][0-9] core.[0-9][0-9][0-9] core.[0-9][0-9][0-9][0-9] core.[0-9][0-9][0-9][0-9][0-9]
...
realclean purge ::  clean realclean_subdirs
	...
	$(RM_RF) $(DISTVNAME)
	$(RM_F)  blib/lib/Acme/6502.pm blib/lib/Acme/6502/Tube.pm $(INST_LIB)/Acme/t.pl $(MAKEFILE_OLD) $(FIRST_MAKEFILE)
...
metafile :
	...
	$(NOECHO) $(ECHO) 'name:         Acme-6502' >> META.yml
	$(NOECHO) $(ECHO) 'version:      v0.0.1' >> META.yml
	$(NOECHO) $(ECHO) 'version_from: lib/Acme/6502.pm' >> META.yml
...
ppd:
	$(NOECHO) $(ECHO) '<SOFTPKG NAME="$(DISTNAME)" VERSION="v0,0,1,0">' > $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <TITLE>$(DISTNAME)</TITLE>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <ABSTRACT>Pure Perl 65C02 simulator.</ABSTRACT>' >> $(DISTNAME).ppd
...
pm_to_blib: $(TO_INST_PM)
	$(NOECHO) $(PERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')'\
	  lib/Acme/6502.pm blib/lib/Acme/6502.pm \
	  t.pl $(INST_LIB)/Acme/t.pl \
	  lib/Acme/6502/Tube.pm blib/lib/Acme/6502/Tube.pm 
	$(NOECHO) $(TOUCH) $@
